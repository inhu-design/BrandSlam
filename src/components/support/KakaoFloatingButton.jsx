...
export default function KakaoFloatingButton() {
  return (
    <a
      ...
      className="pointer-events-auto group relative shrink-0 rounded-full shadow-[0_8px_28px_rgba(0,0,0,0.35)] ring-2 ring-black/10 transition-transform duration-300 hover:scale-105 hover:ring-yellow-300/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
