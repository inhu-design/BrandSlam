# KG이니시스 신용카드 결제 연동 가이드

KG이니시스에 결제 신청 후 발급받은 **MID(상점아이디)** 와 **웹결제 Sign Key**를 환경 변수로 설정하면 신용카드 결제가 동작합니다.  
...
1. **결제 단계**에서 결제 수단을 **계좌이체** / **신용카드** 중 선택
2. **신용카드** 선택 후 **신용카드 결제** 클릭  
   → 주문·캠페인 생성 후 이니시스 결제창(팝업) 오픈
3. 이니시스 결제창에서 카드 정보 입력 후 결제
